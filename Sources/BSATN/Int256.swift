public struct Int256: Equatable, Hashable, CustomStringConvertible, Codable {
    public let u0: UInt64
    public let u1: UInt64
    public let u2: UInt64
    public let u3: UInt64

    public init(u0: UInt64 = 0, u1: UInt64 = 0, u2: UInt64 = 0, u3: UInt64 = 0) {
        self.u0 = u0
        self.u1 = u1
        self.u2 = u2
        self.u3 = u3
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard hexString.count == 64 else {
            throw DecodingError.dataCorruptedError(in: container, debugDescription: "Int256 hex string must be 64 characters")
        }
        ...
        guard let u0 = UInt64(u0Hex, radix: 16),
            ...
            throw DecodingError.dataCorruptedError(in: container, debugDescription: "Invalid hex string for Int256")
        }
