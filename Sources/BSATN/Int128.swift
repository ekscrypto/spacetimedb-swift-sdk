public struct Int128: Equatable, Hashable, CustomStringConvertible, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard hexString.count == 32 else {
            throw DecodingError.dataCorruptedError(in: container, debugDescription: "Int128 hex string must be 32 characters")
        }
        ...
        guard let u0 = UInt64(u0Hex, radix: 16),
            ...
            throw DecodingError.dataCorruptedError(in: container, debugDescription: "Invalid hex string for Int128")
        }
